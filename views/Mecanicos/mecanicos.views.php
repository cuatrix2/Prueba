...
?>
    ...
    <body>
        ...
        <main id="main" class="main">
                        ...
                        <div class="col-lg-12 mb-4">
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    ...
                                    <button  type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalMecanico">Nuevo <?php echo $_SESSION["ruta"] ?> </button>
                                </div>
                                <div class="card-body">
            ...
            <!-- Modal -->
            <div class="modal fade" id="modalMecanico" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h1 class="modal-title fs-5" id="TituloModalMecanico">Nuevo Mecanico</h1>
                            <button type="button" onclick="limpiar()" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                        </div>
                        
                    <form id= "Mecanicos_form">
        ...
        <script src="mecanicos.js"></script>
</body>
</html>
