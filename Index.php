          ...
          <div class="row justify-content-center">
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="d-flex justify-content-center py-4">
                <a href="./views/Dashboard/Home.php" class="logo d-flex align-items-center w-auto">
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <form class="row g-3 needs-validation" action="controllers/empleados.controller.php?op=login" method="post">
                    ...
                    <div class="col-12">
                      ...
                      <div class="input-group has-validation">
                        ...
                        <input type="text" name="em_correo" class="form-control" id="em_correo" required>
                    ...
                    <div class="col-12">
                      ...
                      <input type="password" name="em_contrasena" class="form-control" id="em_contrasena" required>
